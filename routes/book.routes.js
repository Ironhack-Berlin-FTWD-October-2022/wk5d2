...
//  This has to be above the /books/:bookId route in case the browser might interpret the /create route as an ID (and not know what to do!)
...
router.get("/books/:bookId", (req, res, next) => {
  //   console.log("booked", req.params);
  const { bookId } = req.params;
  Book.findById(bookId)
    .then((theBook) => console.log("books/book-details.hbs", theBook))
